                    ...
                    <div className="space-y-5" onKeyPress={handleKeyPress}>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 transition-all"
                                    id="email"
                                    type="email"
                                    value={user.email}
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                className="h-4 w-4 rounded border-white/20 bg-white/10 text-blue-500 focus:ring-blue-500 focus:ring-offset-0 cursor-pointer"
                                disabled={loading}
                            />
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button className="flex items-center justify-center px-4 py-2 border border-white/20 rounded-lg hover:bg-white/10 transition-all">
